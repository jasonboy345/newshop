...
<!--编辑页面，从数据库读取数据，显示在表单域中，再覆盖写到数据库-->
    <?php
        ...
        //4.定义查询SQL语句，并执行需要修改的具体行数
        $sql = "select * from type where id=".($_GET['id']+0);
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：类别管理&nbsp;&nbsp;>&nbsp;&nbsp;<a href="edit.php">修改分类</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="action.php?book=update">
